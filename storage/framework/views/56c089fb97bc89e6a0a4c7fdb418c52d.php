<div class="kanban" id="kanban-board">
    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $this->kanbanData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stageId => $stageData): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="column" id="stage-<?php echo e(\Str::kebab( $stageData['name'] )); ?>" data-stage-id="<?php echo e($stageId); ?>">
            <div class="d-flex titleContainer">
                <p class="title"><?php echo e($stageData['name']); ?></p>
                <p class="title column-task-counter"><?php echo e($stageData['tasksCount']); ?></p>
            </div>
            <div class="body">
                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $stageData['tasks']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php echo $__env->make('kanban::kanban.single-task', ['task' => $task], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php $__env->startPush('scripts'); ?>
    <script>
        ...
        const availableStages = [
            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $this->project->stages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stage): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                document.querySelector('#stage-<?php echo e(\Str::kebab( $stage->name )); ?>'),
        ...
        document.addEventListener('livewire:initialized', function() {
            ...
            dragula(dragulaContainers)
                .on('drop', (cardNode, target, source, sibling) => {
                    ...
                    window.Livewire.find('<?php echo e($_instance->getId()); ?>').dispatch('kanban::task-moved', [taskId, sourceStageId, targetStageId, siblingTaskId]);
                });
            ...
            document.addEventListener('kanban:column-scrolled-to-bottom', (data) => {
                ...
                window.Livewire.find('<?php echo e($_instance->getId()); ?>').dispatch('kanban::load-more-tasks', [stageId]);
            });
...
<?php $__env->stopPush(); ?>
<?php /**PATH D:\OSPanel\domains\kanban\modules/Kanban\Resources/Views/kanban/kanban.blade.php ENDPATH**/ ?>