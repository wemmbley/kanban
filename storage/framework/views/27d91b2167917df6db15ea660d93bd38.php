    ...
    <script>
        document.addEventListener('livewire:initialized', () => {
            ...
            newCommentRichEditor.on('text-change', function () {
                ...
                window.Livewire.find('<?php echo e($_instance->getId()); ?>').set('commentText', content);
            });
        });
    </script>
<?php $__env->stopPush(); ?>
<?php /**PATH D:\OSPanel\domains\kanban\modules/Kanban\Resources/Views/kanban/modals/view-task.blade.php ENDPATH**/ ?>